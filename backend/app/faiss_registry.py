from .faiss_manager import FaissManager, FaceFaissManager
import os
...
# Face embeddings (ArcFace / 512-D)
face_faiss = FaceFaissManager(use_hnsw=FAISS_USE_HNSW)

__all__ = ["text_faiss", "vision_faiss", "face_faiss"]
